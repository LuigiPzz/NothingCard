package com.nothing.card.data.remote.google
...
class GoogleDriveService @Inject constructor(
    ...
    private fun getDriveService(account: GoogleSignInAccount): Drive {
        ...
        return Drive.Builder(
            ...
            credential
        ).setApplicationName("Nothing Card").build()
    }
    ...
    suspend fun uploadSyncFile(account: GoogleSignInAccount, jsonContent: String) = withContext(Dispatchers.IO) {
        ...
        val query = "name = 'nothing_card_sync.json' and 'appDataFolder' in parents"
